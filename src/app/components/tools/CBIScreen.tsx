...
// ── Component ─────────────────────────────────────────────────────────────────
export function CBIScreen({ onDone, onStartTool, onOpenChatWithPrompt }: CBIScreenProps) {
  ...
  const severity: AssessmentSeverity =
    overall.label === "Low Burnout" ? "positive" :
    overall.label === "Moderate Burnout" ? "moderate" : "high";
    ...
    <div className="min-h-screen flex flex-col px-5 pt-14 pb-10" style={{ background: DONE_BG }}>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <span style={{ fontFamily: "Inter, sans-serif", fontSize: 13, fontWeight: 600, color: "#9CA3AF" }}>
          Copenhagen Burnout Inventory Complete
        </span>
        <div style={{ width: 44 }} />
      </div>
